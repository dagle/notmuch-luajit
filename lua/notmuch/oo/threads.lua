...
local messages = require("../notmuch.messages")
...
function M:toplevel_messages()
	return u.wrap_iterator(nm.thread_get_toplevel_messages(self.thread), messages)
end

function M:get_messages()
	return u.wrap_iterator(nm.thread_get_messages(self.thread), messages)
end

function M:matched_messages()
	return u.wrap_iterator(nm.thread_get_matched_messages(self.thread), messages)
end
