...
local threads = require("../notmuch.threads")
...
function M:get_threads()
	return u.wrap_iterator(nm.query_get_threads(self.query), threads)
end


function M:get_messages()
	return u.wrap_iterator(nm.query_get_messages(self.query), messages)
end
